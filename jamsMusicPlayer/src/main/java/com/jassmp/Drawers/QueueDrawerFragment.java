...
public class QueueDrawerFragment {
    //
    ...
    //        mMiniPlayerAlbumArt.setImageBitmap( mApp.getAudioPlaybackService().getCurrentSong().getAlbumArt() );
    //        mTitleText.setText( mApp.getAudioPlaybackService().getCurrentSong().getTitle() );
    //        mSubText.setText( mApp.getAudioPlaybackService().getCurrentSong().getAlbum() + " - " +
    ...
    //        }
    //
    //        mListViewAdapter = new QueueDrawerAdapter( mContext, mApp.getAudioPlaybackService()
    ...
    //         */
    //        if( !isDrawerOpen() ) {
    //            mListView.setSelection( mApp.getAudioPlaybackService().getCurrentSongIndex() );
    //        }
    //
    //    }
    //
    ...
    //            if( mApp.isServiceRunning() ) {
    //                mApp.getAudioPlaybackService().skipToTrack( position );
    //            }
    //
    //        }
    //
    ...
    //                    //One of the next songs was moved to a position before the current song. Move currentSongIndex
    //                    // forward by 1.
    ...
    //                } else if( from < mApp.getAudioPlaybackService().getCurrentSongIndex()
    //                           && to > mApp.getAudioPlaybackService().getCurrentSongIndex() ) {
    //                    //One of the previous songs was moved to a position after the current song. Move
    // currentSongIndex
    //                    // back by 1.
    //                    mApp.getAudioPlaybackService().decrementCurrentSongIndex();
    //                    mApp.getAudioPlaybackService().decrementEnqueueReorderScalar();
    ...
    //            if( mApp.getAudioPlaybackService().getPlaybackIndecesList().size() > (
    //                    mApp.getAudioPlaybackService().getCurrentSongIndex() + 1 ) ) {
    //                if( mListViewAdapter.getItem( which ) == mApp.getAudioPlaybackService()
    //                                                             .getPlaybackIndecesList()
    ...
    //                    mApp.getAudioPlaybackService().prepareAlternateMediaPlayer();
    //
    //                } else if( mListViewAdapter.getItem( which ) == mApp.getAudioPlaybackService()
    //                                                                    .getPlaybackIndecesList()
    //                                                                    .get( mApp.getAudioPlaybackService()
    //                                                                              .getCurrentSongIndex() ) ) {
    //                    mApp.getAudioPlaybackService().incrementCurrentSongIndex();
    ...
    //                }
    //
    //            } else if( which == ( mApp.getAudioPlaybackService().getPlaybackIndecesList().size() - 1 )
    //                       && mApp.getAudioPlaybackService().getCurrentSongIndex() == (
    //                    mApp.getAudioPlaybackService().getPlaybackIndecesList().size() - 1 ) ) {
