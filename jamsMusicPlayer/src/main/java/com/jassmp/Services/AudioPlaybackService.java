...
import com.jassmp.RemoteControlClient.RemoteControlHelper;
import com.jassmp.Utils.Common;
import com.jassmp.WidgetProviders.AlbumArtWidgetProvider;
import com.jassmp.WidgetProviders.BlurredWidgetProvider;
import com.jassmp.WidgetProviders.LargeWidgetProvider;
import com.jassmp.WidgetProviders.SmallWidgetProvider;
...
public class AudioPlaybackService extends Service {
    ...
    private Notification buildJBNotification( SongHelper songHelper ) {
        ...
        PendingIntent launchNowPlayingPendingIntent = PendingIntent.getBroadcast( mContext.getApplicationContext(), 0,
...
/*				newCursor.moveToPosition(j);
    ...
    private Runnable duckDownVolumeRunnable = new Runnable() {
        ...
        public void run() {
            if( mAudioManagerHelper.getCurrentVolume() > mAudioManagerHelper.getTargetVolume() ) {
                mAudioManager.setStreamVolume( AudioManager.STREAM_MUSIC, ( mAudioManagerHelper.getCurrentVolume()
                                                                            - mAudioManagerHelper.getStepDownIncrement() ),
                                               0 );
    ...
    private Runnable duckUpVolumeRunnable = new Runnable() {
        ...
        public void run() {
            if( mAudioManagerHelper.getCurrentVolume() < mAudioManagerHelper.getTargetVolume() ) {
                mAudioManager.setStreamVolume( AudioManager.STREAM_MUSIC, ( mAudioManagerHelper.getCurrentVolume()
                                                                            + mAudioManagerHelper.getStepUpIncrement() ),
                                               0 );
    ...
    public void updateWidgets() {
        try {
            ...
            int smallWidgetIds[] = AppWidgetManager.getInstance( mContext )
                                                   .getAppWidgetIds(
                                                           new ComponentName( mContext, SmallWidgetProvider.class ) );
            ...
            int largeWidgetIds[] = AppWidgetManager.getInstance( mContext )
                                                   .getAppWidgetIds(
                                                           new ComponentName( mContext, LargeWidgetProvider.class ) );
    ...
    private void startMediaPlayer() throws IllegalStateException {
        ...
        String[] flagValues = new String[]{ getCurrentSongIndex() + "", "", "", getMediaPlayer().getDuration() + "",
                                            "" };
    ...
    private void startMediaPlayer2() throws IllegalStateException {
        ...
        String[] flagValues = new String[]{ getCurrentSongIndex() + "", "", "", getMediaPlayer2().getDuration() + "",
                                            "" };
