...
public class RemoteControlClientCompat {
    ...
    private Object       mActualRemoteControlClient = null;
    ...
    static {
        try {
            ...
            sRegisterRemoteControlClientMethod = AudioManager.class.getMethod( "registerRemoteControlClient",
                                                                               new Class[]{
                                                                                       sRemoteControlClientClass } );
            sUnregisterRemoteControlClientMethod = AudioManager.class.getMethod( "unregisterRemoteControlClient",
                                                                                 new Class[]{
                                                                                         sRemoteControlClientClass } );
    ...
    public RemoteControlClientCompat( final AudioManager audioManager, final PendingIntent pendingIntent ) {
        if( !sHasRemoteControlAPIs ) {
            return;
        }
        try {
            mAudioManager = audioManager;
            mActualRemoteControlClient = sRemoteControlClientClass.getConstructor( PendingIntent.class )
        ...
        private MetadataEditorCompat( Object actualMetadataEditor ) {
            if( sHasRemoteControlAPIs && actualMetadataEditor == null ) {
                throw new IllegalArgumentException(
                        "Remote Control API's exist, " + "should not be given a null MetadataEditor" );
            }
            if( sHasRemoteControlAPIs ) {
    ...
    private void registerRemoteControlClient() {
        ...
        try {
            sRegisterRemoteControlClientMethod.invoke( mAudioManager, getActualRemoteControlClientObject() );
        } catch( Exception e ) {
    ...
    public void destroy() {
        ...
        try {
            sUnregisterRemoteControlClientMethod.invoke( mAudioManager, getActualRemoteControlClientObject() );
        } catch( Exception e ) {
            Log.e( TAG, e.getMessage(), e );
        }
    }
