...
public class SettingsMusicLibraryFragment extends PreferenceFragment {
    ...
    public View onCreateView( LayoutInflater inflater, ViewGroup container, Bundle onSavedInstanceState ) {
        ...
        mRefreshMusicFoldersPreference = getPreferenceManager().findPreference(
     ...
     */
    private Preference.OnPreferenceClickListener selectMusicFoldersClickListener
     ...
     */
    private Preference.OnPreferenceClickListener refreshMusicFoldersClickListener
            = new Preference.OnPreferenceClickListener() {
