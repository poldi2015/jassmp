...
public class ViewStyleHelper {
    ...
    public void styleAndInitQuickScroll( final QuickScroll quickScroll, final ListView listView, final Scrollable adapter ) {
    ...
    public void styleTileText( final TextView titleText ) {
        titleText.setTextColor( UIElementsHelper.getThemeBasedTextColor( mContext ) );
