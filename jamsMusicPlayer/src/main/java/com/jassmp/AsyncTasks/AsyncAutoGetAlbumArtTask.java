...
public class AsyncAutoGetAlbumArtTask extends AsyncTask<String, String, Void> {
    ...
    public void onProgressUpdate( String... values ) {
        ...
        AutoFetchAlbumArtService.builder.setContentTitle(
                mContext.getResources().getString( R.string.downloading_missing_cover_art ) );
        ...
        NotificationManager notifyManager = (NotificationManager) mContext.getSystemService(
    ...
    protected void onPostExecute( Void arg0 ) {
        ...
        AutoFetchAlbumArtService.builder.setTicker(
                mContext.getResources().getString( R.string.done_downloading_art ) );
        AutoFetchAlbumArtService.builder.setContentTitle(
                mContext.getResources().getString( R.string.done_downloading_art ) );
        AutoFetchAlbumArtService.builder.setSmallIcon( R.drawable.notif_icon );
        AutoFetchAlbumArtService.builder.setContentInfo( null );
