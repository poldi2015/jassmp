...
public class FilterListViewItemAdapter extends SimpleCursorAdapter implements Scrollable {
    ...
    public FilterListViewItemAdapter( final Context context, final FilterCursorAdapter cursorAdapter,
                                      final MainActivity.FragmentId fragmentId ) {
    ...
    public abstract static class Holder {
        ...
        public static Holder getHolder( final Common app, final View itemView,
                                        final MainActivity.FragmentId fragmentId, final int numberOfListItems ) {
