...
public class MediaStoreAccessHelper {
    ...
    public static Cursor getAllUniqueArtists( Context context ) {
        ...
        return contentResolver.query( MediaStore.Audio.Artists.EXTERNAL_CONTENT_URI, projection, null, null,
    ...
    public static Cursor getAllUniqueAlbums( Context context ) {
        ...
        return contentResolver.query( MediaStore.Audio.Albums.EXTERNAL_CONTENT_URI, projection, null, null,
    ...
    public static Cursor getAllUniqueGenres( Context context ) {
        ...
        return contentResolver.query( MediaStore.Audio.Genres.EXTERNAL_CONTENT_URI, projection, null, null,
    ...
    public static Cursor getAllUniquePlaylists( Context context ) {
        ...
        return contentResolver.query( MediaStore.Audio.Playlists.EXTERNAL_CONTENT_URI, projection, null, null,
